...
pub enum GetApiV2ManifestsAppVersionSuccess {
    Status200(crate::models::GetApiV2ManifestsAppVersion200Response),
...
pub enum PostApiV2AuthLoginSuccess {
    Status200(crate::models::Apiv2AuthLoginPostResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum PostApiV2AuthValidateSuccess {
    Status200(crate::models::Apiv2AuthValidatePostResponse),
    UnknownValue(serde_json::Value),
}
...
pub enum PostApiV2TokensSuccess {
    Status200(crate::models::PostApiV2Tokens200Response),
    Status204(),
    UnknownValue(serde_json::Value),
}
...
pub enum GetApiV2ManifestsAppVersionError {
    ...
    Status404(crate::models::GetApiV2ManifestsAppVersion404Response),
...
pub async fn post_api_v2_auth_login(
    configuration: &configuration::Configuration,
    apiv2_auth_login_post_request: Option<crate::models::Apiv2AuthLoginPostRequest>,
...
pub async fn post_api_v2_auth_validate(
    configuration: &configuration::Configuration,
    apiv2_auth_validate_post_request: Option<crate::models::Apiv2AuthValidatePostRequest>,
...
pub async fn post_api_v2_tokens(
    ...
    authorization: &str,
    x_session_id: &str,
    post_api_v2_tokens_request: Option<crate::models::PostApiV2TokensRequest>,
